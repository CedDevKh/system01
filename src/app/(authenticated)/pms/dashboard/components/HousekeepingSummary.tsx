    ...
    <Card className="h-full">
      ...
      <CardContent className="p-3">
        <div className="grid grid-cols-2 gap-2 text-sm">
          ...
          <div className="rounded-md border border-border p-2">
            <div className="text-xs text-muted-foreground">Needs inspection</div>
            <div className="mt-1 text-lg font-semibold text-foreground">
              {props.needsInspectionCount}
            </div>
          </div>
          <div className="rounded-md border border-border p-2">
            <div className="text-xs text-muted-foreground">Arrivals not clean</div>
            <div
              className={
                "mt-1 text-lg font-semibold " +
                (props.arrivalsNotCleanCount > 0 ? "text-red-700" : "text-foreground")
              }
            >
